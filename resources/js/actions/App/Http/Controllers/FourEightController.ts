 ...
 * @see app/Http/Controllers/FourEightController.php:14
 * @route '/2048'
 */
const FourEightController = (options?: {
  query?: QueryParams;
 ...
 * @route '/2048'
 */
FourEightController.url = (options?: {
  query?: QueryParams;
  mergeQuery?: QueryParams;
}) => {
 ...
 * @route '/2048'
 */
FourEightController.get = (options?: {
  query?: QueryParams;
  mergeQuery?: QueryParams;
}): {
  url: string;
 ...
 * @route '/2048'
 */
FourEightController.head = (options?: {
  query?: QueryParams;
  mergeQuery?: QueryParams;
}): {
  url: string;
